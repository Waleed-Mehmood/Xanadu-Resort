...
function ourRooms() {
    ...
    <div className="relative w-full min-h-screen">
      ...
      <div className="relative z-10 max-w-4xl mx-auto pt-16 pb-20 px-4">
        ...
        <div className="text-center mb-8">
          ...
          <button className="absolute top-32 left-[6rem] sm:left-[15rem] md:left-[20rem] lg:left-[23rem] flex items-center justify-between gap-2 px-10 py-2 text-sm font-medium text-white bg-transparent rounded-full border border-gray-700 transition-all hover:bg-gray-900 hover:bg-opacity-30 z-10">
  ...
  <div className="flex-1 relative overflow-hidden  shadow-lg">
    ...
    />
    <div className="absolute bottom-0 left-0 w-full h-[47%] bg-black bg-opacity-60 text-white px-4 py-6 flex flex-col justify-end">
